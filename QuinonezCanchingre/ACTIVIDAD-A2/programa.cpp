	...
	do 
	{
		...
		switch(opcion)
		{
			    case 1:
					 ...
					 cout<<"\t\t\t--------------Sub Menú de Opciones--------------"<<endl;
				 	cout<<"\t\t\t------------------------------------------------"<<endl;
				 	...
				 	cout<<"0. Salir"<<endl;
				 	cout<<"Ingrese una opción: "; cin>>opcion2;
				 	switch(opcion2)
			     	{
					case 1:
						 int zp_aa, zp_bb ;
				    	...
				    	cout<<"//================================================"<<endl;
                        cout<<"Nombre del programa: comparar números"<<endl;
                        ...
                        cout<<"//================================================"<<endl;
						cout<<"Presione enter nuevamente para regresar al menú";
						system("pause>null");
					break;
					case 2:
					...
					case 3:
						...
						cout<<"\n\tCalcular la Edad\n\n";
						cout << "Ingrese Año Actual: ";   cin >> zp_anoAct;
						cout << "Ingrese Mes Actual: ";   cin >> zp_mesAct;
						cout << "Ingrese Dia Actual: ";  cin >> zp_diaAct;
		
						cout << "\nIngrese Año Nacimiento: ";  cin >> zp_anoNac;
						cout << "Ingrese Mes de Nacimiento: ";  cin >> zp_mesNac;
						cout << "Ingrese Dia de Nacimiento: ";  cin >> zp_diaNac;
						...
						if (zp_anoAct > zp_anoNac)
						{
							...
							cout << "\n Calculo no es posible ";
                             ...
                             cout<<"Autor: Pervis Zurita"<<endl;
                             cout<<"Fecha de elaboración:29-04-2022"<<endl;
					...
					int zp_ax, zp_bx, zp_cx;
						...
						cout<<"Ingrese el primer número a sumar: "; cin>>zp_ax;
						cout<<"Ingrese el segundo número a sumar: "; cin>>zp_bx;
						zp_cx = zp_ax+zp_bx;
						cout<<"\n\tResultado"<<endl;
			...
			case 2:
					...
					case 1:
						 int ac_aa, ac_bb ;
							cout<<"Ingrese el primer número a comparar: ";  cin>> ac_aa;  
							cout<<"Ingrese el segundo número a comparar: ";  cin>> ac_bb;
							if (ac_aa==ac_bb)
								cout<<"Son iguales"<<endl;
							else
								if (ac_aa>ac_bb)
				    	...
				    	cout<<"//================================================"<<endl;
                        cout<<"Nombre del programa: comparar números"<<endl;
                        cout<<"Archivo: QuiñonezAlisson-comprara.cpp"<<endl;
					...
					case 2:
					 ...
					 cout<<"//================================================"<<endl;
                     cout<<"Nombre del programa: cuenta moneda"<<endl;
                     cout<<"Archivo: QuiñonezAlisson-CuentaMoneda.cpp"<<endl;
                     cout<<"Autor: Alisson Quiñonez"<<endl;
                     cout<<"Fecha de elaboracion:29-04-2022"<<endl;
					...
					case 3:
						...
						if (ac_anoAct > ac_anoNac)
						{
							...
							cout << "\n Calculo no es posible ";
				         	...
				         	cout<<"//================================================"<<endl;
                             cout<<"Nombre del programa: calcular la edad"<<endl;
                             cout<<"Archivo: QuiñonezAlisson-laedad.cpp"<<endl;
                             cout<<"Autor:  Alisson Quiñonez"<<endl;
                             cout<<"Fecha de elaboración:29-04-2022"<<endl;
                             cout<<"Fecha de actualización: 18-05-2022"<<endl;
                             cout<<"//================================================"<<endl;
					...
					case 4:
					 	...
					 	do
						{
						 ...
						 cout<<"//================================================"<<endl;
					 	cout<<"//==> Nombre del programa: Punto de venta"<<endl;
					 	cout<<"//==> Archivo : QuiñonezAlisson-puntoventa.cpp"<<endl;
					 	cout<<"//==>Autor: Alisson Quiñonez"<<endl;
					 	cout<<"//==>Fecha de elaboración: 2022-04-29"<<endl;
					 	cout<<"//==>Fecha ultima actualización: 2022-05-18"<<endl;
					 	cout<<"//================================================="<<endl;
					...
					int ac_ax, ac_bx, ac_cx;
						...
						cout<<"//================================================"<<endl;
						cout<<"//==> Nombre del programa: suma de 2 numeros"<<endl;
						cout<<"//==> Archivo : QuiñonezAlisson-suma.cpp"<<endl;
						cout<<"//==>Autor: Alisson Quiñonez"<<endl;
						cout<<"//==>Fecha de elaboración: 2022-04-29"<<endl;
						cout<<"//==>Fecha ultima actualización: 2022-05-18"<<endl;
						cout<<"//================================================="<<endl;
			...
			case 3:
					...
					int cz_ax, cz_bx, cz_cx;
						cout<<"\n\tSUMA DE 2 NÚMEROS"<<endl;
						cout<<"Ingrese el primer número a sumar: "; cin>>cz_ax;
						cout<<"Ingrese el segundo número a sumar: "; cin>>cz_bx;
						cz_cx = cz_ax+cz_bx;
						cout<<"\n\tResultado"<<endl;
